...
**Five payment schemes for AI agents on Sui — exact, prepaid, escrow, streaming, and SEAL pay-to-decrypt. 1,775 tests. 10 packages. Apache 2.0.**
...
| [`@sweefi/solana`](packages/solana) | Solana s402 payment adapter | 42 |
...
**Total: 1,775 passing tests (1,349 TypeScript + 426 Move)**
