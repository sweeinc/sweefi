...
export default defineConfig({
  title: 'SweeFi',
  description: 'Open-source agentic payment infrastructure for Sui. Five payment schemes. $extend() plugin. Built for AI agents that spend money autonomously.',
  cleanUrls: true,
  lastUpdated: true,
  sitemap: {
  ...
  head: [
    ...
    ['meta', { property: 'og:description', content: 'Open-source agentic payment infrastructure for Sui. Five payment schemes. $extend() plugin. Built for AI agents that spend money autonomously.' }],
